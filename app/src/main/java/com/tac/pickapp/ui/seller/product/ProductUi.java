...
import com.tac.pickapp.ui.seller.adapter.ProductAdapter;
...
public abstract class ProductUi extends Fragment implements ProductAdapter.OnItemClickListener {
    ...
    protected void init() {
        productVM.getProductResult().observe(getViewLifecycleOwner(), new ResultObserver<List<Product>>() {
            ...
            public void onSuccess(List<Product> products) {
                ...
                if (products.size() < 1) {
                    ...
                    productAdapter = new ProductAdapter(getContext(), products, ProductUi.this);
    ...
    public void onClick(Product product) {
        ...
        Navigation.findNavController(getActivity(), R.id.seller_nav_host_fragment)
                .navigate(R.id.action_nav_store_to_nav_add_product, bundle);
    }
}
